...
const App = () => {
	...
	return (
		<>
			...
			<Main>
				<Form completedTodos={completedTodos} setCompletedTodos={setCompletedTodos}/>
				<Todos title="my todos" completedTodos={completedTodos} setCompletedTodos={setCompletedTodos}/>
			</Main>
		</>
	);
};
